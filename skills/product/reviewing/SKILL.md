...
id: reviewing
type: dispatcher
tags: [review, code-review, quality, audit, pr-review]
dispatches_to: opc-reviewer
triggers:
  keywords: [审查, 审核, review, code review, 质量检查, quick review, deep review]
  phrases: ["审查一下", "看看有没有问题", "code review", "评审"]
version: 1.4.1
---
# reviewing — 审查派发器
