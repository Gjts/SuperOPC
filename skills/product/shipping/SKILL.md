...
id: shipping
type: dispatcher
tags: [shipping, release, merge, pr, deploy, publish, worktree-cleanup]
dispatches_to: opc-shipper
triggers:
  keywords: [发布, 合并, pr, ship, 部署, merge, release, publish, 上线]
  phrases: ["ship it", "发布", "创建 PR", "合并", "准备发布"]
version: 1.4.1
---
# shipping — 发布派发器
